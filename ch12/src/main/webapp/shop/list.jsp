<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import = "bookshop.master.*,java.util.*" %>
...
%>
     <table width="600" align="center"> 
       ...
       <tr height="30" bgcolor="<%=value_c%>"> 
         <td width="350">정가 : <span style="text-decoration: line-through;">
         	<fmt:formatNumber value="<%=bookList.getBook_price()%>"/></span><br>
            판매가 : <b><fmt:formatNumber value="<%=(int)(bookList.getBook_price()*((double)(100-bookList.getDiscount_rate())/100))%>"/></b></td> 
       </tr>        
     </table> 
<%     }   %>
</body></html>