...
<%
      ...
      %>   <tr> 
          ...
          <td align="center"  width="100">\<fmt:formatNumber value="<%=cart.getBuy_price()%>"/></td>
        ...
        <form name="im" method="post" action="updateCart.jsp"
          ...
          <td align="center"  width="150" align="center">
              ...
              \<fmt:formatNumber value="<%=cart.getBuy_count()*cart.getBuy_price()%>"/>
             <input type="button" value="삭제" onclick="location.href='cartListDel.jsp?list=<%=cart.getCart_id()%>&book_kind=<%=book_kind%>'">
          </td>
       </tr>  
<%     }	%>
       <tr>
          <td colspan="5" align="right"><b>총 금액 : \<fmt:formatNumber value="<%=total%>"/></b></td>
      </tr>
       <tr>
