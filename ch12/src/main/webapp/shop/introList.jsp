...
<%             
     ...
     <table width="600" align="center"> 
       ...
       <tr height="30"> 
         <td width="350">정가 : <span style="text-decoration: line-through;"><fmt:formatNumber value="<%=bookLists[j].getBook_price() %>"></fmt:formatNumber></span>원<br>
            판매가 : <b><fmt:formatNumber value="<%=(int)(bookLists[j].getBook_price()*((double)(100-bookLists[j].getDiscount_rate())/100))%>"/></b>원</td> 
       </tr> 
     </table>
<% 
     }
